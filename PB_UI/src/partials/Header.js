        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            ...
            <Link to="/" className="block" aria-label="Cruip">
              <img className="md:max-w-none" src={require('../images/privacybot_head.svg')} width="70" height="32" alt="Robot Logo" />
              {/* <svg className="w-8 h-8 fill-current text-purple-600" viewBox="0 0 32 32" xmlns="../images/bot_background_removed.svg">
          ...
          <nav className="hidden md:flex md:flex-grow">
            ...
            {/*<ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <Link to="/about" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">About Us</Link>
              </li>
              <li>
                <Link to="/signup" className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3">Coming Soon</Link>
              </li>
            </ul>*/}
          ...
          <div className="md:hidden">
            ...
            {/*<nav id="mobile-nav" ref={mobileNav} className="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" style={mobileNavOpen ? { maxHeight: mobileNav.current.scrollHeight, opacity: 1 } : { maxHeight: 0, opacity: .8 } }>
              <ul className="bg-gray-800 px-4 py-2">
                ...
                {/*<li>
                  <Link to="/about" className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center">About Us</Link>
                </li>
                <li>
                  <Link to="#0" className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-white bg-purple-600 hover:bg-purple-700 transition duration-150 ease-in-out">Coming Soon</Link>
                </li>
              </ul>
            </nav>*/}
